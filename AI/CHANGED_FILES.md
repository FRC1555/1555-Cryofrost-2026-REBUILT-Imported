...
- `src/main/deploy/Choreo/New Path Blue Shoot.chor` (removed)
- `src/main/java/frc/robot/Configs.java`
- `src/main/deploy/pathplanner/settings.json`
- `src/main/java/frc/robot/Constants.java`
- `src/main/java/frc/robot/HubShiftUtil.java`
...
- `src/main/java/frc/robot/subsystems/TransferSubSystem.java` (removed)
